...
// 부분투명한 오브젝트 이전에 렌더링한다.
// 불투명 오브젝트를 렌더링 한 후에 렌더링.
// 즉, 디퍼드렌더링 텍스처에 렌더링 하는 셈.
...
D3D12_RASTERIZER_DESC TextureBlendAnimationShader::CreateRasterizerState()
{
...
D3D12_BLEND_DESC TextureBlendAnimationShader::CreateBlendState()
{
...
D3D12_DEPTH_STENCIL_DESC TextureBlendAnimationShader::CreateDepthStencilState()
{
